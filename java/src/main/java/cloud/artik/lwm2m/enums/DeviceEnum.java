...
public enum DeviceEnum implements Lwm2mEnum {
    ...
    REBOOT(4), // Reboot the LWM2M Device to restore the Device from unexpected
               // firmware failure.
    FACTORY_RESET(5), /*
                       * Perform factory reset of the LWM2M Device to make the
                       ...
                       */
    AVAILABLE_POWER_SOURCES(6), /*
                                 * 0 – DC power 1 – Internal Battery 2 –
    ...
    BATTERY_LEVEL(9), // Contains the current battery level as a percentage
                      ...
                      // when the value of Available Power Sources Resource is
                      // 1.
